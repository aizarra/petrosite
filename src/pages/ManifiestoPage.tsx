      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-8 pt-24 pb-20">
        ...
        <article className="max-w-none">
          ...
          <div className="bg-white/5 border-l-4 border-protest-red p-6 mb-6">
            <p className="font-body text-base md:text-lg text-white/90 mb-4">
          ...
          <ul className="list-none space-y-3 mb-6">
            <li className="flex items-start gap-3">
              ...
              <span className="font-body text-base md:text-lg text-white/90">Transfiere las actividades primarias reservadas al Estado a empresas privadas (violación del Art. 302).</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 bg-protest-red flex-shrink-0 mt-2"></span>
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 bg-protest-red flex-shrink-0 mt-2"></span>
              <span className="font-body text-base md:text-lg text-white/90">Introduce el arbitraje internacional para disputas petroleras (violación del Art. 151).</span>
            </li>
          </ul>
          ...
          <div className="space-y-6 mb-12">
            <div className="bg-white/5 p-6 border-l-4 border-protest-red">
              <h3 className="font-body text-lg md:text-xl text-white font-semibold mb-2">1. Derogación inmediata de la reforma a la Ley Orgánica de Hidrocarburos.</h3>
              <p className="font-body text-base md:text-lg text-white/80">Una ley que viola la Constitución es nula de pleno derecho. No puede producir efectos jurídicos válidos. Exigimos su derogación y la reversión de cualquier acto administrativo derivado de ella.</p>
            </div>

            <div className="bg-white/5 p-6 border-l-4 border-protest-red">
              <h3 className="font-body text-lg md:text-xl text-white font-semibold mb-2">2. Publicación íntegra de todos los contratos petroleros firmados bajo la Ley Antibloqueo.</h3>
              <p className="font-body text-base md:text-lg text-white/80">El pueblo venezolano tiene derecho a saber quiénes son los beneficiarios de los Contratos de Participación Productiva, qué áreas se han entregado, bajo qué términos, y cuál es la participación real del Estado. La opacidad es incompatible con la soberanía.</p>
            </div>
          ...
          <p className="font-body text-xl md:text-2xl text-white font-semibold mb-6">
            Este manifiesto no es de izquierda ni de derecha. No es chavista ni antichavista. No es oficialista ni opositor.
          </p>

          <p className="font-body text-xl md:text-2xl text-protest-red font-semibold mb-6">
            Es venezolano.
          </p>
          ...
          <p className="font-body text-xl md:text-2xl text-white font-semibold mb-12">
